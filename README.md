...
Hello React Front-end is a web application that displays a random greeting message on screen the app [Hello Rails Backend](https://github.com/hydaline-code/connect-Backend) API.
...
This [API](https://github.com/hydaline-code/connect-Backend)
...
Feel free to check the [issues page](https://github.com/hydaline-code/Frontend-connect/issues).
